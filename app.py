...
def compress_and_optimize_video(input_path, max_height=720, target_fps=20):
    """Downscales video to 720p @ 20 FPS to prevent RAM crashes."""
    ...
    with VideoFileClip(input_path) as clip:
        ...
        clip.write_videofile(output_path, codec="libx264", audio=False, preset="ultrafast", bitrate="1200k", logger=None)
    return output_path

# Single-line minified SVG logo
...
# ==========================================
# 6. SIDEBAR & BRANDING HEADER (FIXED)
# ==========================================
with st.sidebar:
    # Single-line markdown header to prevent CommonMark parsing errors
...
# 7. MAIN DASHBOARD
# ==========================================
st.markdown('<div class="badge-pill"><svg width="12" height="12" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#8B5CF6"/></svg> Gemini 3.5 Flash Multimodal Vision Active</div>', unsafe_allow_html=True)
